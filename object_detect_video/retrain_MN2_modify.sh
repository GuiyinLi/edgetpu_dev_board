...
# Teriminal下执行 export TPU_CODE_DIR=/home/pi/Work/edgetpu_dev_board_release
TPU_CODE_DIR=/home/pi/Work/edgetpu_dev_board_release
...
do
    ...
    OUTPUT_VIDEO_DIR=${TPU_CODE_DIR}/output_video/
