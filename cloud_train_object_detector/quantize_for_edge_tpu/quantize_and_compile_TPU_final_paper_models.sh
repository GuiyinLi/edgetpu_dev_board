# take the ckpt from the FINAL PAPER SUBMISSION and re-quantize

# From the tensorflow/models/research/ directory
TF_MODELS_DIR=/HD1Data/deepcutV2/tensorflow-models/research

# assuming we want to re-compile the models from our final paper

# name of final model
NAME=recompile_final_paper_joint_waymo_construction_MN2_quantized

BASE_DATA_DIR=/HD1Data/HarvestNet/final_paper_results

# where is the pb file located
MODEL_DIR=${BASE_DATA_DIR}/saved_final_models_from_paper_submit/

# checkpoint of mobilenet v2
CHECKPOINT_PATH=$MODEL_DIR/ckpt_quantized_MN2/model.ckpt
...
PIPELINE_CONFIG_PATH=$MODEL_DIR/ckpt_quantized_MN2/pipeline.config
